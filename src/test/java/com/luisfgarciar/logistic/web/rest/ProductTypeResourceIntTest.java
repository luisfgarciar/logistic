...
import com.luisfgarciar.logistic.repository.ProductTypeRepository;
...
import static com.luisfgarciar.logistic.web.rest.TestUtil.createFormattingConversionService;
...
public class ProductTypeResourceIntTest {
    ...
    private static final String DEFAULT_ALIAS = "AAA";
    private static final String UPDATED_ALIAS = "BBB";
    ...
    public void createProductType() throws Exception {
        ...
        assertThat(testProductType.getAlias()).isEqualTo(DEFAULT_ALIAS);
    }
    ...
    public void updateProductType() throws Exception {
        ...
        assertThat(testProductType.getAlias()).isEqualTo(UPDATED_ALIAS);
    }
