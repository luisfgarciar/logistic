...
import com.luisfgarciar.logistic.domain.Provider;
import com.luisfgarciar.logistic.repository.ProviderRepository;
...
public class ProviderResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = "%'@u.f";
    private static final String UPDATED_EMAIL = "mE@iY.~";
